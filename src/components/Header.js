...
export default function Header() {
  ...
  return (
    <>
        <div className='bg-color-brand-primary-color '>
            <div className={(onlyWidth >= 768 ? "justify-content-between" : "justify-content-center") + " container mx-auto d-flex align-items-center headers"}>
            <a href='#'>
                ...
                {onlyWidth >= 768 && 
                    <nav className='d-flex gap-5'>
                        <a className='d-flex align-items-center gap-2 justify-content-center text-white text-decoration-none fs-14' href="#">
                            <BsGlobe2 />
                            Türkçe (TR)
                        </a>
                        <a className='d-flex align-items-center gap-2 justify-content-center text-white text-decoration-none fs-14' href="#">
        ...
        {onlyWidth < 768 && 
            (
                <div className='d-flex bg-white w-100 p-2 align-items-center justify-content-between text-color-brand-primary-color'>
                    <div className='d-flex gap-2 align-items-center'>
                        <IoLocationSharp />
                        <span className='fs-15 weight-600 text-dark'>Teslimat Adresi Belirle</span>
                    </div>
                    <div>
